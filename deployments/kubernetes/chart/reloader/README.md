...
| `reloader.deployment.livenessProbe`             | Set liveness probe values (timeouts, httpGet path/port)                                                                                                                           | map    | `{}`              |
| `reloader.deployment.readinessProbe`            | Set readiness probe values (timeouts, httpGet path/port)                                                                                                                          | map    | `{}`              |
