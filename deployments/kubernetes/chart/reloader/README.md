...
| `reloader.isJobs`                   | Enable Kubernetes `Jobs`. Valid value are either `true` or `false`                                                                                  | boolean     | `true`    |
| `reloader.isCronJobs`              |  Enable Kubernetes `CronJobs`. Valid value are either `true` or `false`                                                                              | boolean     | `true`    |
